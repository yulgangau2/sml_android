...
public class ImageDownloder {
    ...
    private static ImageDownloder customVolleyRequest;
    ...
    private ImageDownloder(Context context) {
    ...
    public static synchronized ImageDownloder getInstance(Context context) {
        if (customVolleyRequest == null) {
            customVolleyRequest = new ImageDownloder(context);
        }

...
public class LoginScreen extends BaseActivity implements ServerListener,GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gplusButton             = (Button) findViewById(R.id.gplusButton);
        emailEditText            = (EditText)findViewById(R.id.emailEditText);
        passwordEditText         = (EditText)findViewById(R.id.passwordEditText);
        rememberMeCheckbox       = (CheckBox)findViewById(R.id.rememberMeCheckbox);
        signupButton             = (TextView)findViewById(R.id.signupButton);
        forgotpasswordButton     = (TextView) findViewById(R.id.forgotpasswordButton);
        showHideButton           = (TextView) findViewById(R.id.showHideButton);
        facebookLginButton       = (LoginButton) findViewById(R.id.facebookLginButton);
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(LoginScreen.this, this)
        ...
        if(loginSession.isRemember()){
            ...
            Log.e("email",loginSession.getRememberEmail());
            Log.e("pass",loginSession.getRememberPassword());
        ...
        signinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.isEmpty()){
                    ...
                    serverRequest.createRequest(LoginScreen.this, params, RequestID.REQ_TO_LOGIN);
        ...
        forgotpasswordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    forgotPasswordDialog = new Dialog(LoginScreen.this);
...
//                            /Validation Part
                            if (forgotEmail.isEmpty()) {
                                ...
                                serverRequest.createRequest(LoginScreen.this,params, RequestID.REQ_FORGOT_PASSWORD);
                            }
                        ...
                        (loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                            ...
                            public void onCompleted(JSONObject object, GraphResponse response) {
                                ...
                                try {
                                    ...
                                    serverRequest.createRequest(LoginScreen.this, params, RequestID.REQ_SOCIAL_LOGIN);
